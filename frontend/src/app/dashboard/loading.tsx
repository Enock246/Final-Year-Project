  ...
  return (
    <main className="flex-1 p-6 md:p-8 bg-background max-w-7xl mx-auto w-full animate-pulse">
      <div className="mb-10 space-y-4">
        <div className="h-10 w-64 bg-muted/50 rounded-2xl"></div>
        <div className="h-6 w-96 bg-muted/50 rounded-xl"></div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {[1, 2, 3, 4, 5, 6].map((i) => (
          <div 
            key={i}
            className="bg-white/40 p-6 rounded-3xl border-4 border-white/50 flex flex-col h-[280px]"
          >
